...
const styles = {
  container: {  display: 'flex', flexFlow: 'column', justifyContent: 'space-between',  padding: '20px', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' },
  card: { display:'flex', flexFlow: "column", alignItems:'center', border: '1px solid #ddd', borderRadius: '8px', padding: '15px', marginBottom: '20px', backgroundColor: '#f9f9f9' },
  button: {width: '200px', height:'40px', padding: '10px 20px', cursor: 'pointer', backgroundColor: '#4CAF50', color: 'white', border: 'none', borderRadius: '4px' },
...
const Quiz = () => {
  ...
  return (
    <section style={{...styles.card, backgroundColor: '#e3f2fd'}}>
      ...
      <button onClick={() => setRespondido(!respondido)} style={styles.button}>{respondido? 'Ocultar': 'Ver'} Resposta</button>
