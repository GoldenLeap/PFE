...
export function Header({ titulo }) {
  return (
    <header style={{ background: '#646cff', padding: '20px', color: 'white', textAlign: 'center' }}>
      <h1>
        {titulo}
      </h1>
    </header>
...
export function CardSaudacao({ nome, temaEscuro }) {
  ...
  return (
    <div style={estilo}>
      ...
      <p>Bem-vindo ao exercicio de componentes com Vite e Functions.</p>
    </div>
  );
}
...
export function ContadorCliques({ cliques, setCliques }) {
  return (
    <div style={{ padding: '15px', border: '1px solid #645cff', marginTop: '10px', borderRadius: '8px' }}>
